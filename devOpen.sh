...
print_help()
{
  printf '%s\n' "Ouvre un environement de développement"
  printf 'Usage: %s [-e|--editor <arg>] [-h|--help] <project>\n' "$0"
  printf '\t%s\n' "<project>: Nom du projet à ouvrir"
  printf '\t%s\n' "-e, --editor: Éditeur à utiliser (default: 'code')"
  printf '\t%s\n' "-h, --help: Prints help"
}
